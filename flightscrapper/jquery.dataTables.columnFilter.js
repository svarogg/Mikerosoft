...
(function ($) {
    ...
    function fnCreateDateRangeInput() {
        ...
        $.fn.dataTableExt.afnFiltering.push(
	        function (oSettings, aData, iDataIndex) {
	            var dStartDate = from.datepicker("option", "dateFormat", "dd/mm/yy");

	            var dEndDate = to.datepicker("option", "dateFormat", "dd/mm/yy");
    ...
    $.fn.columnFilter = function (options) {
        ...
        return this.each(function () {
            ...
            if(properties.sPlaceHolder.indexOf("head") == 0){
                var tr = $("thead tr:last").clone();
                tr.find("th").attr("class", "");
